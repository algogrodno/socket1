...
sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM) # ip адрксс, TCP
...
while True:
        ...
        #print('---new data----', "\n", addr, "\n", conn, "\n", sock)
                ...
                #     data = conn.recv(1024) # если соединение не закрыто залипает на этой строчке                
                #     if not data:
                #         break
                        #print(data.decode())
